                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Edit Work Section</li>
                    ...
                    <div class="row my-4">
                        <div class="col-xl-8 col-lg-8 col-md-8 mx-auto">
                            ...
                            <div class="content_section">
                                ...
                                <hr>
                                @foreach($workEdit as $row)
                                <form action="{{ route('admin.workUpdate',$row->id) }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-lg-8">
                                                <textarea name="text" id="logo" rows="3" class="form-control" required>{{ $row->content }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
